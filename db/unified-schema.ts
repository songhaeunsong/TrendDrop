// 통합 스키마 초안 — docs/trend-data-schema-and-api-spec.md(2절),
// docs/page-analysis-and-backend-design.md(6장), docs/trend-rising-rename-plan.md를
// 코드로 옮긴 것이다. 검토·리뷰용이며 아직 앱에 연결되어 있지 않다(db/schema.ts 무변경).
// 실제 컷오버(팀 파일 수정·데이터 마이그레이션)는 별도 작업.
import {
  bigint,
  boolean,
  integer,
...
// db/schema.ts의 sources와 동일 — 변경 없음.
